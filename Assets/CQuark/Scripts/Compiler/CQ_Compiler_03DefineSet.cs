...
namespace CQuark
{
    ...
    {
        public ICQ_Expression Compiler_Expression_Define(IList<Token> tlist, CQ_Environment env, int pos, int posend)
        {
        ...
        public ICQ_Expression Compiler_Expression_DefineArray(IList<Token> tlist, CQ_Environment env, int pos, int posend)
        {
            CQ_Expression_Define define = new CQ_Expression_Define(pos, posend, tlist[pos].line, tlist[posend].line);
            {
                ICQ_Type type = env.GetTypeByKeyword(tlist[pos].text + "[]");
        ...
        public ICQ_Expression Compiler_Expression_Lambda(IList<Token> tlist, CQ_Environment env, int pos, int posend)
        {
            int b1;
            int fs1 = pos;
        ...
        public ICQ_Expression Compiler_Expression_DefineAndSet(IList<Token> tlist, CQ_Environment env, int pos, int posend)
        {
            int expbegin =pos+3;
            int bdep;
        ...
        public ICQ_Expression Compiler_Expression_DefineAndSetArray(IList<Token> tlist, CQ_Environment env, int pos, int posend)
        {
            int expbegin = pos + 5;
            int bdep;
            int expend = FindCodeAny(tlist, ref expbegin, out bdep);
        ...
        public ICQ_Expression Compiler_Expression_Set(IList<Token> tlist, CQ_Environment env, int pos, int posend)
        {
            int expbegin = pos + 2;
            int bdep;
            int expend = FindCodeAny(tlist, ref expbegin, out bdep);
