...
namespace CQuark {
    ...
    public class Class_CQuark : IClass {
        ...
        public CQ_Value StaticCall (CQ_Content contentParent, string function, List<CQ_Value> _params) {
            return StaticCall(contentParent, function, _params, null);
        }
        public CQ_Value StaticCall (CQ_Content contentParent, string function, List<CQ_Value> _params, MethodCache cache) {
            if(cache != null) {
        ...
        public CQ_Value MemberCall (CQ_Content contentParent, object object_this, string func, List<CQ_Value> _params) {
            return MemberCall(contentParent, object_this, func, _params, null);
        }
        public CQ_Value MemberCall (CQ_Content contentParent, object object_this, string func, List<CQ_Value> _params, MethodCache cache) {
            if(cache != null) {
                cache.cachefail = true;
            }
        ...
        public virtual IEnumerator CoroutineCall (CQ_Content contentParent, object object_this, string func, List<CQ_Value> _params, UnityEngine.MonoBehaviour coroutine) {
            //TODO
            Function funccache = null;
            if(this.functions.TryGetValue(func, out funccache)) {
                if(funccache.bStatic == false) {
