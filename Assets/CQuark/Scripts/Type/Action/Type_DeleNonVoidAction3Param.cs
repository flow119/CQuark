...
namespace CQuark
{
    ...
    /// </summary>
	public class Type_DeleNonVoidAction<ReturnType, T, T1, T2> : Type_Action
    {
        /// <summary>
        /// 有返回值,同时带 3 个 参数的委托.
        /// </summary>
            ...
            NonVoidDelegate dele = delegate(T param0, T1 param1, T2 param2)
            {
                ...
                if (func.expr_runtime != null)
                {
                    ...
                    try
                    {
                        ...
                        p2.SetValue(func._paramtypes[0].typeBridge, param2);
                        content.DefineAndSet(func._paramnames[2], p2);
            ...
            NonVoidDelegate dele = delegate(T param0, T1 param1, T2 param2)
            {
                if (expr != null)
                {
                    try
                    {
                        ...
                        CQ_Value p2 = new CQ_Value();
                        p2.SetValue(typeof(T2), param2);
                        content.DefineAndSet(pnames[2], p2);
